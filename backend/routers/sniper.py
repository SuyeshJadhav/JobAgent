...
def get_sniper_answers(payload: AnswerRequest):
    ...
    try:
        ...
        response_payload = llm_answers if (llm_answers and isinstance(llm_answers, dict)) else {
            q: "Could not generate answer." for q in payload.questions}
            ...
            try:
                ...
                if pdf_path and pdf_path.exists():
                    with open(pdf_path, "rb") as pdf_file:
                        response_payload["resume_base64"] = base64.b64encode(
