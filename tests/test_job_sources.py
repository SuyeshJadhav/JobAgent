...
def test_deduplicate_jobs():
    jobs = [
        {"company": "Google Inc", "title": "SWE", "location": "Remote", "description": "Short desc"},
        {"company": "Google", "title": "SWE", "location": "Remote, USA", "description": "Longer description here..."},
        {"company": "Google Corp.", "title": "SWE", "location": "Remote", "description": ""}
    ]
    ...
    assert len(unique) <= 2 # Depending on exact location stripping ("Remote, USA" may yield "remoteusa", "Remote" -> "remote")
    
    # Exact identical fingerprints:
    jobs2 = [
        {"company": "Stripe", "title": "SWE Intern", "location": "San Francisco", "description": ""},
        {"company": "Stripe", "title": "SWE Intern", "location": "San Francisco", "description": "Actual JD text here"}
    ]
